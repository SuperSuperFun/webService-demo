 ...
 * 
 */
@WebServiceClient(name = "JwsServiceHelloService", targetNamespace = "http://service.wangli.com/", wsdlLocation = "http://10.0.2.29:8080/Service/ServiceHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName JWSSERVICEHELLOSERVICE_QNAME = new QName("http://service.wangli.com/", "JwsServiceHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.0.2.29:8080/Service/ServiceHello?wsdl");
    ...
    public JwsServiceHello getJwsServiceHelloPort() {
        return super.getPort(new QName("http://service.wangli.com/", "JwsServiceHelloPort"), JwsServiceHello.class);
    }
    ...
    public JwsServiceHello getJwsServiceHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.wangli.com/", "JwsServiceHelloPort"), JwsServiceHello.class, features);
    }
