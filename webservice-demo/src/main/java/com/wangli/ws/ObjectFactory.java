 ...
 * generated in the com.wangli.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValueResponse_QNAME = new QName("http://service.wangli.com/", "getValueResponse");
    private final static QName _GetValue_QNAME = new QName("http://service.wangli.com/", "getValue");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wangli.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.wangli.com/", name = "getValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.wangli.com/", name = "getValue")
